...
Each session gets a dedicated temp directory. Python code runs in a subprocess
with the working directory set to the sandbox dir. The subprocess inherits a
minimal environment: PATH (for python), PYTHONPATH (empty), and explicitly
allowed packages. No access to the host filesystem outside the sandbox.
"""
...
from remi.domain.sandbox.types import ExecResult, ExecStatus, SandboxSession
