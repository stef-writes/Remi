...
def register_vector_tools(
    ...
    *,
    ...
    registry.register(
        ...
        ToolDefinition(
            ...
            args=[
                ...
                ToolArg(
                    name="entity_type",
                    description="Filter by type: Tenant, Unit, Property, MaintenanceRequest, DocumentRow",
                ),
                ToolArg(
                    name="manager_id",
    ...
    registry.register(
        ...
        ToolDefinition(
            name="vector_stats",
            description="Get statistics about the vector embedding index: total count, counts by entity type.",
            args=[],
        ),
    )
