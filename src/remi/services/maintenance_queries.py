...
from remi.models.properties import MaintenanceStatus, PropertyStore
...
class MaintenanceQueryService:
    ...
    async def maintenance_summary(self, property_id: str | None = None) -> MaintenanceSummaryResult:
